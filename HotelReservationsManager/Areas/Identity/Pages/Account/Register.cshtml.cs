    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var currUser = await _userManager.FindByEmailAsync(Input.Email);
                    Console.WriteLine("idto na curruser");
                    Console.WriteLine(currUser.Id);
                    await _userManager.AddToRoleAsync(currUser, UserRoleName);
                    _logger.LogInformation("User created a new account with password.");
                   // await _userManager.AddToRoleAsync(result, UserRoleName);
