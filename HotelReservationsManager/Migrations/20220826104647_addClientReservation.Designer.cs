...
namespace HotelReservationsManager.Migrations
{
    ...
    [Migration("20220826104647_addClientReservation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HotelReservationsManager.Data.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HotelReservationsManager.Data.Entities.Reservation", b =>
                {
                    b.Navigation("ClientsReservation");
                });
